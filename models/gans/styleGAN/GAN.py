...
import models.gans.losses as losses
# from . import update_average
...
class StyleGAN2(BaseGAN):
    ...
    def build_generator(self, config):
        ...
        optimizer = torch.optim.Adam(gen.parameters(), lr=opt_config['lr'])
    ...
    def build_discriminator(self, config):
        ...
        optimizer = torch.optim.Adam(disc.parameters(), lr=opt_config['lr'])
